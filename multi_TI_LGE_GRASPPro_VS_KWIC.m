...
for ii=1:nt-2
    kdatau(:,:,:,ii)=kdata1(:,(ii-1)*nspokes+1-(nshare/2)+12:(ii)*nspokes+(nshare/2)+12,:);
    ku(:,:,ii)= kdata2(:,(ii-1)*nspokes+1-(nshare/2)+12:(ii)*nspokes+(nshare/2)+12);
end
...
for ii=1:nt-2
    kdatau(:,:,:,ii)=kdata1(:,(ii-1)*nspokes+1-(nshare/2)+12:(ii)*nspokes+(nshare/2)+12,:);
    ku(:,:,ii)= kdata_corr(:,(ii-1)*nspokes+1-(nshare/2)+12:(ii)*nspokes+(nshare/2)+12);
end
% param.E = MCNUFFT_2D_GPU_kxyt(ku,w,b1sens);
